...
class AutonomousAgentConfig(BaseModel):
    ...
    You must make a decision and not only check the information. In all the cases, after making your decision and potentially buying ALEPH, respond by explaining your reasoning process."""
