...
export default function LandingPage() {
	...
	const features = useMemo(
		() => ["Decentralized Governance", "Autonomous AI Agents", "Self-Funding Mechanism", "Blockchain Security"],
		[],
	);
		...
		<>
			<PageContainer>
				<div className="-z-10 absolute h-full w-full bg-background">
					<div className="relative h-full w-full bg-[radial-gradient(#bb0ad6_1px,transparent_1px)] [background-size:32px_32px] [mask-image:radial-gradient(ellipse_40%_33%_at_50%_33%,#000_70%,transparent_100%)]" />
				</div>
					...
					<div className="lg:grid lg:gap-x-16 xl:gap-x-24">
						...
						<div className="mx-auto max-w-3xl text-center">
							...
							<p className="mt-6 text-xl leading-8 text-muted-foreground">
								...
								computing power. Experience trustless transactions powered by <strong>Coinbase Base</strong>,{" "}
							...
							<ul className="mx-auto mt-10 grid max-w-xs grid-cols-1 items-center gap-2 sm:max-w-md sm:grid-cols-2">
								{features.map((feature) => (
									<li key={feature} className="flex items-center rounded-md border bg-card p-2">
										<div className="mx-2 ">
